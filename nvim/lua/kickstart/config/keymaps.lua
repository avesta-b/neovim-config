...
-- delete to null register and then paste
...
-- Making splits
vim.keymap.set("n", "<leader>sh", ":split<CR>", { desc = "horizontal" })
-- vim.keymap.set("n", "<leader>wss", ":split<CR>", { desc = "horizontal" })
vim.keymap.set("n", "<leader>sv", ":vsplit<CR>", { desc = "vertical" })
...
-- Terminal
vim.keymap.set("n", "<leader>tt", ":NeotermToggle<CR>", { desc = "toggle terminal" })
